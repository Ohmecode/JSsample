...
import java.awt.event.*;
 ...
 public class cute extends JFrame implements ActionListener{
  JPanel p2;
  JLabel label2;
  JLabel label3;
  JLabel label5;
 ...
 cute(String title){
    ...
    ImageIcon icon = new ImageIcon("./CCs/images/header/header_cute.jpg");
    ...
    JTextArea textarea1 = new JTextArea("RGB(255,67,134)");
    ...
    JTextArea textarea2 = new JTextArea("RGB(245,114,192)");
    ...
    JTextArea textarea3 = new JTextArea("RGB(252,231,220)");
    ...
    JTextArea textarea6 = new JTextArea("RGB(252,231,220)");
    ...
    JTextArea textarea7 = new JTextArea("RGB(158,74,92)");
    ...
    JTextArea textarea8 = new JTextArea("RGB(255,83,116)");
    ...
    JTextArea textarea9 = new JTextArea("RGB(246,168,107)");
    ...
    JTextArea textarea10 = new JTextArea("RGB(192,227,250)");
    ...
    JTextArea textarea11 = new JTextArea("RGB(237,41,139)");
    ...
    JTextArea textarea12 = new JTextArea("RGB(250,162,191)");
    ...
    JTextArea textarea13 = new JTextArea("RGB(255,143,91)");
    ...
    JTextArea textarea14 = new JTextArea("RGB(199,237,249)");
    ...
    button1.setBackground(new Color(255,67,134));
    ...
    button2.setBackground(new Color(245,114,192));
    ...
    button3.setBackground(new Color(252,231,220));
    ...
    button4.setBackground(new Color( 252,231,220));
    ...
    button5.setBackground(new Color(158,74,92));
    ...
    button6.setBackground(new Color(255,83,116));
    ...
    button7.setBackground(new Color(246,168,107));
    ...
    button8.setBackground(new Color(192,227,250));
    ...
    button9.setBackground(new Color(237,41,139));
    ...
    button10.setBackground(new Color(250,162,191));
    ...
    button11.setBackground(new Color(255,143,91));
    ...
    button12.setBackground(new Color(199,237,249));
  ...
  public void actionPerformed(ActionEvent e){
    ...
    {
      p2.add(textarea4);
      textarea4.setText("RGB(252,231,220)");
      gbc1.gridx = 0;
      gbc1.gridy = 2;
      ...
      label2.setBackground(new Color(252,231,220));
    ...
    {
      p2.add(textarea4);
      textarea4.setText("RGB(255,67,134)");
      gbc1.gridx = 0;
      gbc1.gridy = 2;
      layout.setConstraints(textarea4, gbc1);
      p2.add(textarea5);
      textarea5.setText("RGB(245,114,192)");
      gbc1.gridx = 1;
      gbc1.gridy = 2;
      layout.setConstraints(textarea5, gbc1);
      p2.add(label2);
      ...
      gbc1.fill = GridBagConstraints.BOTH;
      layout.setConstraints(label3, gbc1);;
      label2.setBackground(new Color(255,67,134));
      label3.setBackground(new Color(245,114,192));
    }
    else if(cmd.equals("Push Button4"))
    {
      p2.add(textarea4);
      textarea4.setText("RGB(158,74,92)");
      gbc1.gridx = 0;
      gbc1.gridy = 2;
      layout.setConstraints(textarea4, gbc1);
      p2.add(textarea5);
      textarea5.setText("RGB(255,83,116)");
      gbc1.gridx = 1;
      gbc1.gridy = 2;
      layout.setConstraints(textarea5, gbc1);
      p2.add(label2);
      ...
      gbc1.fill = GridBagConstraints.BOTH;
      layout.setConstraints(label3, gbc1);
      label2.setBackground(new Color(158,74,92));
      label3.setBackground(new Color(255,83,116));
    }
    ...
    {
      p2.add(textarea4);
      textarea4.setText("RGB(237,41,139)");
      gbc1.gridx = 0;
      gbc1.gridy = 2;
      layout.setConstraints(textarea4, gbc1);
      p2.add(textarea5);
      ...
      gbc1.fill = GridBagConstraints.BOTH;
      layout.setConstraints(label3, gbc1);
      label2.setBackground(new Color(237,41,139));
      label3.setBackground(null);
    }
    ...
    {
      p2.add(textarea4);
      textarea4.setText("RGB(192,227,250)");
      gbc1.gridx = 0;
      gbc1.gridy = 2;
      layout.setConstraints(textarea4, gbc1);
      p2.add(textarea5);
      ...
      gbc1.fill = GridBagConstraints.BOTH;
      layout.setConstraints(label3, gbc1);
      label2.setBackground(new Color(192,227,250));
      label3.setBackground(null);
    }
    else if(cmd.equals("Push Button10"))
    {
      p2.add(textarea4);
      textarea4.setText("RGB(255,243,91)");
      gbc1.gridx = 0;
      gbc1.gridy = 2;
      layout.setConstraints(textarea4, gbc1);
      p2.add(textarea5);
      textarea5.setText("RGB(199,237,249)");
      gbc1.gridx = 1;
      gbc1.gridy = 2;
      layout.setConstraints(textarea5, gbc1);
      p2.add(label2);
      ...
      gbc1.fill = GridBagConstraints.BOTH;
      layout.setConstraints(label3, gbc1);
      label2.setBackground(new Color(255,243,91));
      label3.setBackground(new Color(199,237,249));
    }
    else if(cmd.equals("Push Button11"))
    {
      p2.add(textarea4);
      textarea4.setText("RGB(250,162,191)");
      gbc1.gridx = 0;
      gbc1.gridy = 2;
      layout.setConstraints(textarea4, gbc1);
      p2.add(textarea5);
      ...
      gbc1.fill = GridBagConstraints.BOTH;
      layout.setConstraints(label3, gbc1);
      label2.setBackground(new Color(250,162,191));
      label3.setBackground(null);
    }
